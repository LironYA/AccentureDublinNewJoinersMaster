...
public class QueryUtils {
    ...
    public static List<GetNews> fetchNewsData(String requestUrl){
        // Create URL object
        ...
        List<GetNews> news = extractFeatureFromJson(jsonResponse);
        return news;
    }
    ...
    private static List<GetNews> extractFeatureFromJson(String newsJSON) {
        // If the JSON string is empty or null, then return early.
        if (TextUtils.isEmpty(newsJSON)) {
            return null;
        }
        // Create an empty ArrayList
        List<GetNews> news = new ArrayList<>();
        try {
            ...
            for (int i = 0; i < newsArray.length(); i++) {
                ...
                GetNews newsN = new GetNews(thumbnail, sectionName, webTitle, author, formattedDate, url);
