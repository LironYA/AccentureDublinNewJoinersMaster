...
import com.example.android.accenturenewjoiners.R;
    ...
    public class ThingsToSeeMain  extends AppCompatActivity {
        protected void onCreate(Bundle savedInstanceState) {
            ...
            viewPager.setAdapter(new PageFragmentThingsToSee(getSupportFragmentManager(),
                    com.example.android.accenturenewjoiners.Activities.ThingsToSee.ThingsToSeeMain.this));
