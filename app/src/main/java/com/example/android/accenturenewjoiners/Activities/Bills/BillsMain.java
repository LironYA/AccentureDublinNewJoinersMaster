...
import com.example.android.accenturenewjoiners.Activities.FindHouse.PageFragmentHouse;
import com.example.android.accenturenewjoiners.R;

public class BillsMain extends AppCompatActivity {
    protected void onCreate(Bundle savedInstanceState) {
        ...
        viewPager.setAdapter(new PageFragmentBills(getSupportFragmentManager(),
                BillsMain.this));
